...
public class HW1FinalTests {
	...
	@Test(timeout = 1000)
	public void Location_construct1() {
	...
	@Test(timeout = 1000)
	public void Location_getBlockIndex1() {
		// test getBlockIndex()
		Location l1 = new Location(1, 0);

		if (l1.getBlockIndex() != 1) {
			failFmt("Location getBlockIndex:\n" + "Expect: l1.getBlockIndex==1\n" + "Actual: l1.getBlockIndex=="
					+ l1.getBlockIndex());
		}
	}

	@Test(timeout = 1000)
	public void Location_getElementIndex1() {
		// test getElementIndex()
		Location l1 = new Location(1, 0);

		if (l1.getElementIndex() != 0) {
			failFmt("Location getElementIndex:\n" + "Expect: l1.getElementIndex==0\n" + "Actual: l1.getElementIndex=="
					+ l1.getElementIndex());
		}
	}

	@Test(timeout = 1000)
	public void Location_toStringForDebugging1() {
		// test toStringForDebugging()
		// output expected to be:
		// blockIndex:2 elementIndex:1
		// Before we check the output, we stip away the white space, resulting
		// in
		// blockIndex:2elementIndex:1
		// So this ignores minor spacing differences between the actual and
		// expected Strins
		Location l1 = new Location(1, 0);
		String result = l1.toStringForDebugging().replaceAll("\\s+", ""); // For
																			// example,
																			// "A
																			// B"
																			// becomes
	...
	@Test(timeout = 1000)
	public void SuperBlock_construct1() {
		// Check construct SuperBlock
		SuperBlock s1 = new SuperBlock(1, 2, 4, 0);

		if (!(s1.number == 1 && s1.maxNumberOfDataBlocks == 2 && s1.maxNumberOfElementsPerBlock == 4
				&& s1.currentNumberOfDataBlocks == 0)) {
	...
	@Test(timeout = 1000)
	public void SuperBlock_getNumber1() {
		// test getNumber()
		SuperBlock s1 = new SuperBlock(1, 2, 4, 0);
	...
	@Test(timeout = 1000)
	public void SuperBlock_getMaxNumberOfDataBlocks1() {
	...
	@Test(timeout = 1000)
	public void SuperBlock_getMaxNumberOfElementsPerBlock1() {
	...
	@Test(timeout = 1000)
	public void SuperBlock_getCurrentNumberOfDataBlocks1() {
	...
	@Test(timeout = 1000)
	public void SuperBlock_incrementCurrentNumberOfDataBlocks1() {
	...
	@Test(timeout = 1000)
	public void SuperBlock_decrementCurrentNumberOfDataBlocks1() {
	...
	@Test(timeout = 1000)
	public void SuperBlock_toStringForDebugging1() {
		// test toStringForDebugging()
		// output expected to be:
		...
		SuperBlock s1 = new SuperBlock(1, 2, 4, 1);
		String result = s1.toStringForDebugging().replaceAll("\\s+", ""); // For
																			// example,
																			// "A
																			// B"
																			// becomes
	...
	@Test(timeout = 1000)
	public void Block_construct1() {
		// Check construct Block
		Block<String> b1 = new Block<String>(1, 2);

		if (!(b1.number == 1 && b1.capacity == 2 && b1.size == 0)) {
			failFmt("Block constructor:\n" + "Expect:b1.number==1 b1.capacity == 2 b1.size==0" + "Actual: b1.number=="
					+ b1.number + " b1.capacity==" + b1.capacity + " b1.size==" + b1.size);
		}
	}

	@Test(timeout = 1000)
	public void Block_getNumber1() {
		// test getCapacity()
		Block<String> b1 = new Block<String>(1, 2);
	...
	@Test(timeout = 1000)
	public void Block_getCapacity1() {
		// test getCapacity()
		Block<String> b1 = new Block<String>(1, 2);

		if (b1.getCapacity() != 2) {
			failFmt("Block getCapacity:\n" + "Expect: +b1.getCapacity==2\n" + "Actual: b1.getCapacity=="
					+ b1.getCapacity());
		}
	}

	@Test(timeout = 1000)
	public void Block_grow1() {
		// test grow()
		Block<String> b1 = new Block<String>(1, 2);
		b1.grow();
	...
	@Test(timeout = 1000)
	public void Block_get_setElement1() {
		// test get/setElement()
		Block<String> b1 = new Block<String>(1, 2);
		b1.grow();
		b1.setElement(0, "A");
		...
		if (!(result.equals("A"))) {
			failFmt("Block setElement:\n" + "Expect: +b1.getElement(0)==A\n" + "Actual: b1.getElement(0)=="
					+ b1.getElement(0));
		}
	}

	@Test(timeout = 1000)
	public void Block_get_setElement2() {
		// test get/setElement()
		Block<String> b1 = new Block<String>(1, 2);
		b1.grow();
		b1.grow();
		...
		if (!(result.equals("B"))) {
			failFmt("Block setElement:\n" + "Expect: +b1.getElement(1)==B\n" + "Actual: b1.getElement(1)=="
					+ b1.getElement(1));
		}
	}

	@Test(timeout = 1000)
	public void Block_shrink3() {
		...
		if (arrayOfElements[1] != null) {
			failFmt("Block shrink:\n" + "Expect: b1.arrayOfElements[1]==null" + "Actual: b1.arrayOfElements[1]=="
					+ (b1.arrayOfElements[1]));
		}
		if (arrayOfElements[0] != null) {
			failFmt("Block shrink:\n" + "Expect: b1.arrayOfElements[0]==null" + "Actual: b1.arrayOfElements[0]=="
					+ (b1.arrayOfElements[0]));
		}
	}

	@Test(timeout = 1000)
	public void Block_toString1() {
		// test toString()
		Block<String> b1 = new Block<String>(1, 2);
		b1.grow();
		b1.setElement(0, "A");
	...
	public void Block_toString2() {
		...
		b1.setElement(0, "A");
		b1.setElement(1, "B");
		String result = b1.toString().replaceAll("\\s+", ""); // "A B" becomes
																// "AB", so does
																// "A B"
	...
	@Test(timeout = 1000)
	public void Block_toStringForDebugging1() {
		// test toStringForDebugging()
		// output expected to be:
		// AB
		// -capacity=2 size=2
		...
		// in
		// AB-capacity=2size=2
		// So this ignores minor spacing differences between expected and actual
		// result
	...
	@Test(timeout = 1000)
	public void DynamicArray_construct1() {
		...
		if (!(d1.sizeOfArrayOfBlocks == 1 && d1.size == 0 && d1.numberOfEmptyDataBlocks == 1
				&& d1.numberOfNonEmptyDataBlocks == 0 && d1.numberOfDataBlocks == 1
				&& d1.indexOfLastNonEmptyDataBlock == -1 && d1.indexOfLastDataBlock == 0 && d1.numberOfSuperBlocks == 1
			...
			failFmt("DynamicArray constructor:\n"
					...
					+ "Actual: d1.sizeOfArrayOfBlocks== " + d1.sizeOfArrayOfBlocks + " d1.size == " + d1.size
					+ " d1.numberOfEmptyDataBlocks==" + d1.numberOfEmptyDataBlocks + " d1.numberOfNonEmptyDataBlocks== "
					+ d1.numberOfNonEmptyDataBlocks + " d1.numberOfDataBlocks== " + d1.numberOfDataBlocks
					+ " d1.indexOfLastNonEmptyDataBlock==" + d1.indexOfLastNonEmptyDataBlock
					+ " d1.indexOfLastDataBlock==" + d1.indexOfLastDataBlock + " d1.numberOfSuperBlocks=="
					+ d1.numberOfSuperBlocks + " d1.lastSuperBlock.getNumber()" + d1.lastSuperBlock.getNumber());
		}
	}

	@Test(timeout = 1000)
	public void DynamicArray_getBlock1() {
		// test getBlock()
		DynamicArray<String> d1 = new DynamicArray<String>();
		...
		if (b.getCapacity() != 1) {
			failFmt("DynamicArray getBlock:\n" + "Expect: +b.getCapacity==1\n" + "Actual: b.getCapacity=="
					+ b.getCapacity());
		}
		if (b.size() != 0) {
			failFmt("DynamicArray getBlock:\n" + "Expect: +b.size==0n" + "Actual: b.size==" + b.size());
		}
	}

	@Test(timeout = 1000)
	public void DynamicArray_size1() {
		// test size()
		DynamicArray<String> d1 = new DynamicArray<String>();
	...
	@Test(timeout = 1000)
	public void DynamicArray_grow1() {
	...
	@Test(timeout = 1000)
	public void DynamicArray_add10() {
		// test add()
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.add("B");
	...
	@Test(timeout = 1000)
	public void DynamicArray_add11() {
		// test add()
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.add("B");
	...
	@Test(timeout = 1000)
	public void DynamicArray_add12() {
		// test add()
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.add("B");
	...
	@Test(timeout = 1000)
	public void DynamicArray_add13() {
		// test add()
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.add("B");
	...
	@Test(timeout = 1000)
	public void DynamicArray_ExpandArray1() {
		// test expandArray()
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.add("B");
	...
	@Test(timeout = 1000)
	public void DynamicArray_ShrinkArray1() {
		// test expandArray()
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.add("B");
	...
	@Test(timeout = 1000)
	public void DynamicArray_get10() {
		// test get()
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.add("B");
	...
	@Test(timeout = 1000)
	public void DynamicArray_get11() {
		// test get()
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.add("B");
	...
	@Test(timeout = 1000)
	public void DynamicArray_GetBlock2() {
		// test getBlock()
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.add("B");
	...
	@Test(timeout = 1000)
	public void DynamicArray_grow2() {
		// test grow() on empty DynamicArray
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.grow(); // grow one space in Block0
		Block b0 = d1.getBlock(0);

		if (!(d1.numberOfDataBlocks == 1 && d1.sizeOfArrayOfBlocks == 1 && d1.numberOfEmptyDataBlocks == 0
				&& d1.numberOfNonEmptyDataBlocks == 1 && d1.indexOfLastNonEmptyDataBlock == 0
				&& d1.indexOfLastDataBlock == 0 && d1.numberOfSuperBlocks == 1 && d1.lastSuperBlock.getNumber() == 0
				&& b0.getNumber() == 0 && b0.getCapacity() == 1 && b0.size() == 1
	...
	public void DynamicArray_grow3() {
		...
		if (!(d1.numberOfDataBlocks == 2 && d1.sizeOfArrayOfBlocks == 2 && d1.numberOfEmptyDataBlocks == 0
				&& d1.numberOfNonEmptyDataBlocks == 2 && d1.indexOfLastNonEmptyDataBlock == 1
				&& d1.indexOfLastDataBlock == 1 && d1.numberOfSuperBlocks == 2 && d1.lastSuperBlock.getNumber() == 1
				&& b1.getNumber() == 1 && b1.getCapacity() == 2 && b1.size() == 1
				&& d1.lastSuperBlock.getMaxNumberOfDataBlocks() == 1
	...
	@Test(timeout = 1000)
	public void DynamicArray_grow4() {
		// test grow() on empty DynamicArray
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.grow(); // grow one space in Block0
		d1.grow(); // create Block1 and grow one space in Block1
		...
		if (!(d1.numberOfDataBlocks == 2 && d1.sizeOfArrayOfBlocks == 2 && d1.numberOfEmptyDataBlocks == 0
				&& d1.numberOfNonEmptyDataBlocks == 2 && d1.indexOfLastNonEmptyDataBlock == 1
				&& d1.indexOfLastDataBlock == 1 && d1.numberOfSuperBlocks == 2 && d1.lastSuperBlock.getNumber() == 1
				&& b1.getNumber() == 1 && b1.getCapacity() == 2 && b1.size() == 2
				&& d1.lastSuperBlock.getMaxNumberOfDataBlocks() == 1
				&& d1.lastSuperBlock.getMaxNumberOfElementsPerBlock() == 2
				&& d1.lastSuperBlock.getCurrentNumberOfDataBlocks() == 1)) {
			failFmt("DynamicArray grow:\n" + "Expect:\n" + "d1.numberOfDataBlocks == 2\n"
	...
	@Test(timeout = 1000)
	public void DynamicArray_grow5() {
		// test grow() on empty DynamicArray
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.grow(); // grow one space in Block0
		d1.grow(); // create Block1 and grow one space in Block1
		...
		if (!(d1.numberOfDataBlocks == 3 && d1.sizeOfArrayOfBlocks == 3 && d1.numberOfEmptyDataBlocks == 0
				&& d1.numberOfNonEmptyDataBlocks == 3 && d1.indexOfLastNonEmptyDataBlock == 2
				&& d1.indexOfLastDataBlock == 2 && d1.numberOfSuperBlocks == 3 && d1.lastSuperBlock.getNumber() == 2
				&& b2.getNumber() == 2 && b2.getCapacity() == 2 && b2.size() == 1
	...
	@Test(timeout = 1000)
	public void DynamicArray_grow6() {
		// test grow() on empty DynamicArray
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.grow(); // grow one space in Block0
		d1.grow(); // create Block1 and grow one space in Block1
		...
		if (!(d1.numberOfDataBlocks == 3 && d1.sizeOfArrayOfBlocks == 3 && d1.numberOfEmptyDataBlocks == 0
				&& d1.numberOfNonEmptyDataBlocks == 3 && d1.indexOfLastNonEmptyDataBlock == 2
				&& d1.indexOfLastDataBlock == 2 && d1.numberOfSuperBlocks == 3 && d1.lastSuperBlock.getNumber() == 2
				&& b2.getNumber() == 2 && b2.getCapacity() == 2 && b2.size() == 2
				&& d1.lastSuperBlock.getMaxNumberOfDataBlocks() == 2
				&& d1.lastSuperBlock.getMaxNumberOfElementsPerBlock() == 2
				&& d1.lastSuperBlock.getCurrentNumberOfDataBlocks() == 1)) {
			failFmt("DynamicArray grow:\n" + "Expect:\n" + "d1.numberOfDataBlocks == 3\n"
	...
	@Test(timeout = 1000)
	public void DynamicArray_grow7() {
		// test grow() on empty DynamicArray
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.grow(); // grow one space in Block0
		d1.grow(); // create Block1 and grow one space in Block1
		...
		if (!(d1.numberOfDataBlocks == 4 && d1.sizeOfArrayOfBlocks == 4 && d1.numberOfEmptyDataBlocks == 0
				&& d1.numberOfNonEmptyDataBlocks == 4 && d1.indexOfLastNonEmptyDataBlock == 3
				&& d1.indexOfLastDataBlock == 3 && d1.numberOfSuperBlocks == 3 && d1.lastSuperBlock.getNumber() == 2
				&& b3.getNumber() == 3 && b3.getCapacity() == 2 && b3.size() == 1
				&& d1.lastSuperBlock.getMaxNumberOfDataBlocks() == 2
				&& d1.lastSuperBlock.getMaxNumberOfElementsPerBlock() == 2
	...
	@Test(timeout = 1000)
	public void DynamicArray_grow8() {
		// test grow() on empty DynamicArray
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.grow(); // grow one space in Block0
		d1.grow(); // create Block1 and grow one space in Block1
		...
		if (!(d1.numberOfDataBlocks == 4 && d1.sizeOfArrayOfBlocks == 4 && d1.numberOfEmptyDataBlocks == 0
				&& d1.numberOfNonEmptyDataBlocks == 4 && d1.indexOfLastNonEmptyDataBlock == 3
				&& d1.indexOfLastDataBlock == 3 && d1.numberOfSuperBlocks == 3 && d1.lastSuperBlock.getNumber() == 2
				&& b3.getNumber() == 3 && b3.getCapacity() == 2 && b3.size() == 2
				&& d1.lastSuperBlock.getMaxNumberOfDataBlocks() == 2
				&& d1.lastSuperBlock.getMaxNumberOfElementsPerBlock() == 2
				&& d1.lastSuperBlock.getCurrentNumberOfDataBlocks() == 2)) {
			failFmt("DynamicArray grow:\n" + "Expect:\n" + "d1.numberOfDataBlocks == 4\n"
	...
	@Test(timeout = 1000)
	public void DynamicArray_grow9() {
		// test grow() on empty DynamicArray
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.grow(); // grow one space in Block0
		d1.grow(); // create Block1 and grow one space in Block1
		...
		if (!(d1.numberOfDataBlocks == 5 && d1.sizeOfArrayOfBlocks == 5 && d1.numberOfEmptyDataBlocks == 0
				&& d1.numberOfNonEmptyDataBlocks == 5 && d1.indexOfLastNonEmptyDataBlock == 4
				&& d1.indexOfLastDataBlock == 4 && d1.numberOfSuperBlocks == 4 && d1.lastSuperBlock.getNumber() == 3
				&& b4.getNumber() == 4 && b4.getCapacity() == 4 && b4.size() == 1
				&& d1.lastSuperBlock.getMaxNumberOfDataBlocks() == 2
	...
	@Test(timeout = 1000)
	public void DynamicArray_grow10() {
		// test grow() on empty DynamicArray
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.grow(); // grow one space in Block0
		d1.grow(); // create Block1 and grow one space in Block1
		...
		if (!(d1.numberOfDataBlocks == 5 && d1.sizeOfArrayOfBlocks == 5 && d1.numberOfEmptyDataBlocks == 0
				&& d1.numberOfNonEmptyDataBlocks == 5 && d1.indexOfLastNonEmptyDataBlock == 4
				&& d1.indexOfLastDataBlock == 4 && d1.numberOfSuperBlocks == 4 && d1.lastSuperBlock.getNumber() == 3
				&& b4.getNumber() == 4 && b4.getCapacity() == 4 && b4.size() == 4
				&& d1.lastSuperBlock.getMaxNumberOfDataBlocks() == 2
				&& d1.lastSuperBlock.getMaxNumberOfElementsPerBlock() == 4
				&& d1.lastSuperBlock.getCurrentNumberOfDataBlocks() == 1)) {
			failFmt("DynamicArray grow:\n" + "Expect:\n" + "d1.numberOfDataBlocks == 5\n"
	...
	@Test(timeout = 1000)
	public void DynamicArray_grow11() {
		// test grow() on empty DynamicArray
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.grow(); // grow one space in Block0
		d1.grow(); // create Block1 and grow one space in Block1
		...
		if (!(d1.numberOfDataBlocks == 6 && d1.sizeOfArrayOfBlocks == 6 && d1.numberOfEmptyDataBlocks == 0
				&& d1.numberOfNonEmptyDataBlocks == 6 && d1.indexOfLastNonEmptyDataBlock == 5
				&& d1.indexOfLastDataBlock == 5 && d1.numberOfSuperBlocks == 4 && d1.lastSuperBlock.getNumber() == 3
				&& b5.getNumber() == 5 && b5.getCapacity() == 4 && b5.size() == 1
				&& d1.lastSuperBlock.getMaxNumberOfDataBlocks() == 2
				&& d1.lastSuperBlock.getMaxNumberOfElementsPerBlock() == 4
				&& d1.lastSuperBlock.getCurrentNumberOfDataBlocks() == 2)) {
	...
	@Test(timeout = 1000)
	public void DynamicArray_grow12() {
		// test grow() on empty DynamicArray
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.grow(); // grow one space in Block0
		d1.grow(); // create Block1 and grow one space in Block1
		...
		if (!(d1.numberOfDataBlocks == 7 && d1.sizeOfArrayOfBlocks == 7 && d1.numberOfEmptyDataBlocks == 0
				&& d1.numberOfNonEmptyDataBlocks == 7 && d1.indexOfLastNonEmptyDataBlock == 6
				&& d1.indexOfLastDataBlock == 6 && d1.numberOfSuperBlocks == 5 && d1.lastSuperBlock.getNumber() == 4
				&& b6.getNumber() == 6 && b6.getCapacity() == 4 && b6.size() == 1
	...
	@Test(timeout = 1000)
	public void DynamicArray_locate1() {
		// test locate
		DynamicArray<String> d1 = new DynamicArray<String>();
	...
	@Test(timeout = 1000)
	public void DynamicArray_locate2() {
		// test locate
		DynamicArray<String> d1 = new DynamicArray<String>();
	...
	@Test(timeout = 1000)
	public void DynamicArray_locate3() {
		// test locate
		DynamicArray<String> d1 = new DynamicArray<String>();
	...
	@Test(timeout = 1000)
	public void DynamicArray_locate4() {
		// test locate
		DynamicArray<String> d1 = new DynamicArray<String>();
	...
	@Test(timeout = 1000)
	public void DynamicArray_locate5() {
		// test locate
		DynamicArray<String> d1 = new DynamicArray<String>();
	...
	@Test(timeout = 1000)
	public void DynamicArray_locate6() {
		// test locate
		DynamicArray<String> d1 = new DynamicArray<String>();
	...
	@Test(timeout = 1000)
	public void DynamicArray_locate7() {
		// test locate
		DynamicArray<String> d1 = new DynamicArray<String>();
	...
	@Test(timeout = 1000)
	public void DynamicArray_locate8() {
		// test locate
		DynamicArray<String> d1 = new DynamicArray<String>();
	...
	@Test(timeout = 1000)
	public void DynamicArray_locate9() {
		// test locate
		DynamicArray<String> d1 = new DynamicArray<String>();
	...
	@Test(timeout = 1000)
	public void DynamicArray_locate10() {
		// test locate
		DynamicArray<String> d1 = new DynamicArray<String>();
	...
	@Test(timeout = 1000)
	public void DynamicArray_locate11() {
		// test locate
		DynamicArray<String> d1 = new DynamicArray<String>();
	...
	@Test(timeout = 1000)
	public void DynamicArray_locate12() {
		// test locate
		DynamicArray<String> d1 = new DynamicArray<String>();
	...
	@Test(timeout = 1000)
	public void DynamicArray_locate13() {
		// test locate
		DynamicArray<String> d1 = new DynamicArray<String>();
	...
	@Test(timeout = 1000)
	public void DynamicArray_locate410() {
		// test locate
		DynamicArray<String> d1 = new DynamicArray<String>();
	...
	@Test(timeout = 1000)
	public void DynamicArray_locate913() {
		// test locate
		DynamicArray<String> d1 = new DynamicArray<String>();
		int index = 913;
		...
		String msg = String.format("locate(%d):\n", index)
	...
	@Test(timeout = 1000)
	public void DynamicArray_locate5123() {
		// test locate
		DynamicArray<String> d1 = new DynamicArray<String>();
		int index = 5123;
	...
	@Test(timeout = 1000)
	public void DynamicArray_remove1() {
		// test remove
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.remove();
		...
		if (!(d1.numberOfDataBlocks == 1 && d1.sizeOfArrayOfBlocks == 1 && d1.numberOfEmptyDataBlocks == 1
				&& d1.numberOfNonEmptyDataBlocks == 0 && d1.indexOfLastNonEmptyDataBlock == -1
				&& d1.indexOfLastDataBlock == 0 && d1.numberOfSuperBlocks == 1 && d1.lastSuperBlock.getNumber() == 0
				&& b0.getNumber() == 0 && b0.getCapacity() == 1 && b0.size() == 0
				&& d1.lastSuperBlock.getMaxNumberOfDataBlocks() == 1
				&& d1.lastSuperBlock.getMaxNumberOfElementsPerBlock() == 1
				&& d1.lastSuperBlock.getCurrentNumberOfDataBlocks() == 1)) {
	...
	@Test(timeout = 1000)
	public void DynamicArray_remove2() {
		// test remove
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.add("B");
	...
	@Test(timeout = 1000)
	public void DynamicArray_remove3() {
		// test remove
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.add("B");
		...
		if (!(d1.numberOfDataBlocks == 3 && d1.sizeOfArrayOfBlocks == 3 && d1.numberOfEmptyDataBlocks == 1
				&& d1.numberOfNonEmptyDataBlocks == 2 && d1.indexOfLastNonEmptyDataBlock == 1
				&& d1.indexOfLastDataBlock == 2 && d1.numberOfSuperBlocks == 3 && d1.lastSuperBlock.getNumber() == 2
				&& b2.getNumber() == 2 && b2.getCapacity() == 2 && b2.size() == 0
				&& d1.lastSuperBlock.getMaxNumberOfDataBlocks() == 2
				&& d1.lastSuperBlock.getMaxNumberOfElementsPerBlock() == 2
				&& d1.lastSuperBlock.getCurrentNumberOfDataBlocks() == 1)) {
			failFmt("DynamicArray remove:\n" + "Expect:\n" + "d1.numberOfDataBlocks == 3\n"
	...
	@Test(timeout = 1000)
	public void DynamicArray_remove4() {
		// test remove
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.add("B");
		...
		if (!(d1.numberOfDataBlocks == 3 && d1.sizeOfArrayOfBlocks == 3 && d1.numberOfEmptyDataBlocks == 1
				&& d1.numberOfNonEmptyDataBlocks == 2 && d1.indexOfLastNonEmptyDataBlock == 1
				&& d1.indexOfLastDataBlock == 2 && d1.numberOfSuperBlocks == 3 && d1.lastSuperBlock.getNumber() == 2
				&& b2.getNumber() == 2 && b2.getCapacity() == 2 && b2.size() == 0 && b1.getNumber() == 1
				&& b1.getCapacity() == 2 && b1.size() == 1 && d1.lastSuperBlock.getMaxNumberOfDataBlocks() == 2
				&& d1.lastSuperBlock.getMaxNumberOfElementsPerBlock() == 2
				&& d1.lastSuperBlock.getCurrentNumberOfDataBlocks() == 1)) {
			failFmt("DynamicArray remove:\n" + "Expect:\n" + "d1.numberOfDataBlocks == 3\n"
					+ "d1.sizeOfArrayOfBlocks == 3\n" + "d1.numberOfEmptyDataBlocks == 1\n"
	...
	@Test(timeout = 1000)
	public void DynamicArray_remove5() {
		// test remove
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.add("B");
		...
		if (!(d1.numberOfDataBlocks == 2 && d1.sizeOfArrayOfBlocks == 2 && d1.numberOfEmptyDataBlocks == 1
				&& d1.numberOfNonEmptyDataBlocks == 1 && d1.indexOfLastNonEmptyDataBlock == 0
				&& d1.indexOfLastDataBlock == 1 && d1.numberOfSuperBlocks == 2 && d1.lastSuperBlock.getNumber() == 1
				&& b1.getNumber() == 1 && b1.getCapacity() == 2 && b1.size() == 0
				&& d1.lastSuperBlock.getMaxNumberOfDataBlocks() == 1
				&& d1.lastSuperBlock.getMaxNumberOfElementsPerBlock() == 2
				&& d1.lastSuperBlock.getCurrentNumberOfDataBlocks() == 1)) {
			failFmt("DynamicArray remove:\n" + "Expect:\n" + "d1.numberOfDataBlocks == 2\n"
	...
	@Test(timeout = 1000)
	public void DynamicArray_remove6() {
		// test remove
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.add("B");
		...
		if (!(d1.numberOfDataBlocks == 4 && d1.sizeOfArrayOfBlocks == 4 && d1.numberOfEmptyDataBlocks == 1
				&& d1.numberOfNonEmptyDataBlocks == 3 && d1.indexOfLastNonEmptyDataBlock == 2
				&& d1.indexOfLastDataBlock == 3 && d1.numberOfSuperBlocks == 3 && d1.lastSuperBlock.getNumber() == 2
				&& b3.getNumber() == 3 && b3.getCapacity() == 2 && b3.size() == 0 && b2.getNumber() == 2
				&& b2.getCapacity() == 2 && b2.size() == 2 && d1.lastSuperBlock.getMaxNumberOfDataBlocks() == 2
				&& d1.lastSuperBlock.getMaxNumberOfElementsPerBlock() == 2
				&& d1.lastSuperBlock.getCurrentNumberOfDataBlocks() == 2)) {
			failFmt("DynamicArray grow:\n" + "Expect:\n" + "d1.numberOfDataBlocks == 4\n"
					+ "d1.sizeOfArrayOfBlocks == 4\n" + "d1.numberOfEmptyDataBlocks == 1\n"
	...
	@Test(timeout = 1000)
	public void DynamicArray_remove7() {
		// test remove()
		DynamicArray<String> d1 = new DynamicArray<String>();
	...
	@Test(timeout = 1000)
	public void DynamicArray_remove8() {
		// test remove()
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
	...
	@Test(timeout = 1000)
	public void DynamicArray_set10() {
		// test set()
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.add("B");
	...
	@Test(timeout = 1000)
	public void DynamicArray_set11() {
		// test set()
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.add("B");
	...
	@Test(timeout = 1000)
	public void DynamicArray_set12() {
		// test set()
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.add("B");
	...
	@Test(timeout = 1000)
	public void DynamicArray_size2() {
		// test size()
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A"); // grow one space in Block0
	...
	@Test(timeout = 1000)
	public void DynamicArray_size3() {
		// test size()
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.add("B");
	...
	@Test(timeout = 1000)
	public void DynamicArray_toString1() {
		// test toString()
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A"); // grow one space in Block0
	...
	@Test(timeout = 1000)
	public void DynamicArray_toString2() {
		// test toString()
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.add("B");
	...
	@Test(timeout = 1000)
	public void DynamicArray_toString3() {
		// test toString()
		DynamicArray<String> d1 = new DynamicArray<String>();
		d1.add("A");
		d1.add("B");
	...
	@Test(timeout = 1000)
	public void DynamicArray_toStringForDebugging1() {
		// test toStringForDebugging()
		...
		d1.add("B");
		d1.add("C");
		String result = d1.toStringForDebugging().replaceAll("\\s+", ""); // remove
																			// all
																			// white
																			// space
		String expect = "DynamicArray:ABCnumberOfDataBlocks:2numberOfEmptyDataBlocks:0numberOfNonEmptyDataBlocks:2indexOfLastNonEmptyDataBlock:1"
	...
	@Test(timeout = 1000)
	public void DynamicQueue_construct1() {
	...
	@Test(timeout = 1000)
	public void DynamicQueue_enqueue2() {
		// Check enqueue
		DynamicQueue<String> q1 = new DynamicQueue<String>();
		q1.enqueue("A");
		q1.enqueue("B");
	...
	@Test(timeout = 1000)
	public void DynamicQueue_dequeue1() {
		// Check dequeue
		DynamicQueue<String> q1 = new DynamicQueue<String>();
		q1.enqueue("A");
		String A = q1.dequeue();
	...
	@Test(timeout = 1000)
	public void DynamicQueue_dequeue2() {
		// Check dequeue
		DynamicQueue<String> q1 = new DynamicQueue<String>();
		q1.enqueue("A");
		q1.enqueue("B");
	...
	@Test(timeout = 1000)
	public void DynamicQueue_dequeue3() {
		// Check dequeue
		DynamicQueue<String> q1 = new DynamicQueue<String>();
		q1.enqueue("A");
		q1.enqueue("B");
	...
	@Test(timeout = 1000)
	public void DynamicQueue_dequeue4() {
		// Check dequeue
		DynamicQueue<String> q1 = new DynamicQueue<String>();
		q1.enqueue("A");
		String A = q1.dequeue();
	...
	@Test(timeout = 1000)
	public void DynamicQueue_size1() {
		// Check size
		DynamicQueue<String> q1 = new DynamicQueue<String>();
		int size = q1.size();
	...
	@Test(timeout = 1000)
	public void DynamicQueue_size2() {
		// Check size
		DynamicQueue<String> q1 = new DynamicQueue<String>();
		q1.enqueue("A");
		int size = q1.size();
	...
	@Test(timeout = 1000)
	public void DynamicQueue_size3() {
		// Check size
		DynamicQueue<String> q1 = new DynamicQueue<String>();
		q1.enqueue("A");
		q1.enqueue("B");
	...
	@Test(timeout = 1000)
	public void DynamicQueue_isEmpty1() {
		// Check isEmpty
		DynamicQueue<String> q1 = new DynamicQueue<String>();
	...
	@Test(timeout = 1000)
	public void DynamicQueue_isEmpty2() {
		// Check isEmpty
		DynamicQueue<String> q1 = new DynamicQueue<String>();
		q1.enqueue("A");
		boolean isEmpty = q1.isEmpty();
	...
	@Test(timeout = 1000)
	public void DynamicQueue_toString1() {
		// Check toString
		DynamicQueue<String> q1 = new DynamicQueue<String>();
		q1.enqueue("A");
		q1.enqueue("B");
	...
	@Test(timeout = 1000)
	public void DynamicQueue_toString2() {
		// Check toString
		DynamicQueue<String> q1 = new DynamicQueue<String>();
		q1.enqueue("A");
		q1.enqueue("B");
	...
	@Test(timeout = 1000)
	public void DynamicQueue_toStringForDebugging1() {
	...
	@Test(timeout = 1000)
	public void DynamicQueue_toStringForDebugging2() {
		// Check toStringForDebugging
		DynamicQueue<String> q1 = new DynamicQueue<String>();
		q1.enqueue("A");
		q1.enqueue("B");
	...
	@Test(timeout = 1000)
	public void DynamicArray_add_stress1() {
		...
		expect = "- maxNumberOfDataBlocks: 8\n" + "- maxNumberOfElementsPerBlock: 8\n"
	...
	@Test(timeout = 1000)
	public void DynamicArray_get_set_stress1() {
		String msg;
		DynamicArray<Integer> da = new DynamicArray<Integer>();
		for (int i = 0; i < 100; i++) {
			da.add(i);
	...
	@Test(timeout = 1000)
	public void DynamicArray_remove_stress1() {
		DynamicArray<Integer> da = new DynamicArray<Integer>();
		for (int i = 0; i < 100; i++) {
			da.add(i);
		}
	...
	@Test(timeout = 1000)
	public void DynamicArray_add_stress2() {
		DynamicArray<Integer> da = new DynamicArray<Integer>();
		...
		expect = "- maxNumberOfDataBlocks: 32\n" + "- maxNumberOfElementsPerBlock: 64\n"
	...
	@Test(timeout = 1000)
	public void DynamicArray_get_set_stress2() {
		String msg;
		DynamicArray<Integer> da = new DynamicArray<Integer>();
		for (int i = 0; i < 2500; i++) {
			da.add(i);
	...
	@Test(timeout = 1000)
	public void DynamicArray_remove_stress2() {
		DynamicArray<Integer> da = new DynamicArray<Integer>();
		for (int i = 0; i < 2500; i++) {
			da.add(i);
		}
